...
#define OLED_DC   GPIO_PIN_5   //数据/命令控制信号   PD5
#define OLED_RST  GPIO_PIN_12   //复位信号           PD12
...
#define OLED_DC_Clr()  HAL_GPIO_WritePin(GPIOD, OLED_DC, GPIO_PIN_RESET)
#define OLED_DC_Set()  HAL_GPIO_WritePin(GPIOD, OLED_DC, GPIO_PIN_SET)
