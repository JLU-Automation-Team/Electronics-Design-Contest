...
//-----------------OLED端口操作定义---------------- 
#define OLED_CS_Clr  P2OUT &= ~OLED_CS
#define OLED_CS_Set  P2OUT |= OLED_CS

#define OLED_DC_Clr  P2OUT &= ~OLED_DC
#define OLED_DC_Set  P2OUT |= OLED_DC
 					   
#define OLED_RST_Clr  P2OUT &= ~OLED_RST
#define OLED_RST_Set  P2OUT |= OLED_RST
